 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,_){var T=E.length;E.push(_);e:for(;0<T;){var O=T-1>>>1,ee=E[O];if(0<i(ee,_))E[O]=_,E[T]=ee,T=O;else break e}}function n(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var _=E[0],T=E.pop();if(T!==_){E[0]=T;e:for(var O=0,ee=E.length,dr=ee>>>1;O<dr;){var zt=2*(O+1)-1,_i=E[zt],jt=zt+1,pr=E[jt];if(0>i(_i,T))jt<ee&&0>i(pr,_i)?(E[O]=pr,E[jt]=T,O=jt):(E[O]=_i,E[zt]=T,O=zt);else if(jt<ee&&0>i(pr,T))E[O]=pr,E[jt]=T,O=jt;else break e}}return _}function i(E,_){var T=E.sortIndex-_.sortIndex;return T!==0?T:E.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,a=o.now();e.unstable_now=function(){return o.now()-a}}var s=[],d=[],g=1,h=null,m=3,w=!1,S=!1,k=!1,D=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(E){for(var _=n(d);_!==null;){if(_.callback===null)r(d);else if(_.startTime<=E)r(d),_.sortIndex=_.expirationTime,t(s,_);else break;_=n(d)}}function v(E){if(k=!1,f(E),!S)if(n(s)!==null)S=!0,We(N);else{var _=n(d);_!==null&&R(v,_.startTime-E)}}function N(E,_){S=!1,k&&(k=!1,p(P),P=-1),w=!0;var T=m;try{for(f(_),h=n(s);h!==null&&(!(h.expirationTime>_)||E&&!Y());){var O=h.callback;if(typeof O=="function"){h.callback=null,m=h.priorityLevel;var ee=O(h.expirationTime<=_);_=e.unstable_now(),typeof ee=="function"?h.callback=ee:h===n(s)&&r(s),f(_)}else r(s);h=n(s)}if(h!==null)var dr=!0;else{var zt=n(d);zt!==null&&R(v,zt.startTime-_),dr=!1}return dr}finally{h=null,m=T,w=!1}}var z=!1,C=null,P=-1,$=5,L=-1;function Y(){return!(e.unstable_now()-L<$)}function Se(){if(C!==null){var E=e.unstable_now();L=E;var _=!0;try{_=C(!0,E)}finally{_?Ke():(z=!1,C=null)}}else z=!1}var Ke;if(typeof c=="function")Ke=function(){c(Se)};else if(typeof MessageChannel<"u"){var b=new MessageChannel,be=b.port2;b.port1.onmessage=Se,Ke=function(){be.postMessage(null)}}else Ke=function(){D(Se,0)};function We(E){C=E,z||(z=!0,Ke())}function R(E,_){P=D(function(){E(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){S||w||(S=!0,We(N))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(E){switch(m){case 1:case 2:case 3:var _=3;break;default:_=m}var T=m;m=_;try{return E()}finally{m=T}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,_){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var T=m;m=E;try{return _()}finally{m=T}},e.unstable_scheduleCallback=function(E,_,T){var O=e.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?O+T:O):T=O,E){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=T+ee,E={id:g++,callback:_,priorityLevel:E,startTime:T,expirationTime:ee,sortIndex:-1},T>O?(E.sortIndex=T,t(d,E),n(s)===null&&E===n(d)&&(k?(p(P),P=-1):k=!0,R(v,T-O))):(E.sortIndex=ee,t(s,E),S||w||(S=!0,We(N))),E},e.unstable_shouldYield=Y,e.unstable_wrapCallback=function(E){var _=m;return function(){var T=m;m=_;try{return E.apply(this,arguments)}finally{m=T}}}})(vs);ys.exports=vs;var Uc=ys.exports;/**
 * @license React
